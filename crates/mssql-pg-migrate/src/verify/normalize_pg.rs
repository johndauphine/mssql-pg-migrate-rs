...
pub fn pg_row_hash_expr(columns: &[Column], pk_columns: &[String]) -> String {
    // Get non-PK columns for hashing (same as MSSQL side)
...
mod tests {
    ...
    fn test_pg_row_hash_expr() {
        ...
        let expr = pg_row_hash_expr(&columns, &pk_columns);
